...
function DetailFilm() {
  ...
  if (!filmDetail) {
    return <div className="not-found">Film not found</div>;
  }

  return (
    <div className='return <div className="not-found">Film not found</div>;'>
      <img src={filmDetail.img} alt={filmDetail.title} className='detail-image'/>
      <h1 className='detail-title'>{filmDetail.title}</h1>
      <p className='detail-description'>{filmDetail.description}</p>
      <p className='detail-genre'><strong>Genre:</strong> {filmDetail.genre}</p>
